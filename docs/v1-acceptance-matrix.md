...
| standalone/IDE 同 binary、HostConfig 优先级、workspace/environment 摘要与 instructions/description | `tests/test_runtime_config.py::test_host_profiles_share_resolution_and_runtime_descriptions`、`tests/test_server_config.py`、`tests/test_mcp_stdio.py` | 三平台共享测试 |
...
- run id: `supervisor-gate-20260825T044840Z-dfdb00fc`
